...
// $upload_dir = './cdn/source/'; // path from base_url to base of upload folder (with start and final /)
...
// $base_url = $http_url;  // base url (only domain) of site (without final /). If you prefer relative urls leave empty
// $upload_dir = '.././../uploads/'; // path from base_url to base of upload folder (with start and final /)
// $current_path = '../../../uploads/'; // path from base_url to base of upload folder (with start and final /)
