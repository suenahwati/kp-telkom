...
<html xmlns="https://www.w3.org/1999/xhtml">
	...
	<link rel="shortcut icon" href="img/ico/favicon.ico">
        <link href="<?php echo dirname(__FILE__).'/css/bootstrap.min.css' ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo dirname(__FILE__).'/css/bootstrap-responsive.min.css' ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo dirname(__FILE__).'/css/bootstrap-lightbox.min.css' ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo dirname(__FILE__).'/css/style.css' ?>" rel="stylesheet" type="text/css" />
